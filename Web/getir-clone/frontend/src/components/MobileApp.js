...
export default function MobileApp() {
  return (
    <div className="bg-tertiary-brand-color flex flex-col md:flex-row justify-between items-center bg-mobile-app md:rounded-lg text-white">
      <div className="flex flex-col gap-y-3 p-10 text-center md:text-left">
        <h3 className="text-2xl font-bold tracking-tight">TatlımıGetir'i indirin!</h3>
